var input, filter, ul, li, a, i, j, div, uid;

function getId(id,chat_type){
    uid = id
    alert(uid)

    // _('http://localhost:4400/chats');
}
...
function themeColor(e) {
    ...
    function o() {
        "users" == m ? (document.getElementById("channel-chat").style.display = "none", document.getElementById("users-chat").style.display = "block") : (document.getElementById("channel-chat").style.display = "block", document.getElementById("users-chat").style.display = "none"), _(s + "chats")
    }
    e("users", function(e, t) {

console.log(t)

        null !== e ? console.log("Something went wrong: " + e) : (t.favorites.forEach(function(e, t) {
            ...
            var a = e.profile ? '<img src="' + e.profile + '" class="rounded-circle avatar-xs" alt=""><span class="user-status"></span>' : '<div class="avatar-xs"><span class="avatar-title rounded-circle bg-primary text-white"><span class="username">JP</span><span class="user-status"></span></span></div>',
                ...
                l = 1 === e._id ? "active" : "";
            document.getElementById("favourite-users").innerHTML += '<li onclick="getId(\'' + e._id + '\',\'chat\')" id="contact-id-' + e._id + '" data-name="favorite" class="' + l + '">                  ' + i + '                       <div class="d-flex align-items-center">                          <div class="chat-user-img online align-self-center me-2 ms-0">                              ' + a + '                          </div>                          <div class="overflow-hidden">                              <p class="text-truncate mb-0">' + e.username + "</p>                          </div>                          " + s + "                      </div>                  </a>              </li>"
        }), t.users.forEach(function(e, t) {
            var a = e.profile ? '<img src="' + e.profile + '" class="rounded-circle avatar-xs" alt=""><span class="user-status"></span>' : '<div class="avatar-xs"><span class="avatar-title rounded-circle bg-primary text-white"><span class="username">JL</span><span class="user-status"></span></span></div>',
                s = e.messagecount ? '<div class="ms-auto"><span class="badge badge-soft-dark rounded p-1">' + e.messagecount + "</span></div>" : "",
                i = e.messagecount ? '<a href="javascript: void(0);" class="unread-msg-user">' : '<a href="javascript: void(0);">';
            document.getElementById("usersList").innerHTML += '<li onclick="getId(\'' + e._id + '\',\'chat\')" id="contact-id-' + e._id + '" data-name="direct-message">                  ' + i + '                   <div class="d-flex align-items-center">                      <div class="chat-user-img online align-self-center me-2 ms-0">                          ' + a + '                      </div>                      <div class="overflow-hidden">                          <p class="text-truncate mb-0">' + e.username + "</p>                      </div>                      " + s + "                  </div>              </a>          </li>"
        }), t.channels.forEach(function(e, t) {
            ...
            document.getElementById("channelList").innerHTML += '<li  onclick="getId(\'' + e._id + '\',\'channels\')" id="contact-id-' + e._id + '" data-name="channel">                ' + s + '                     <div class="d-flex align-items-center">                        <div class="flex-shrink-0 avatar-xs me-2">                            <span class="avatar-title rounded-circle bg-soft-light text-dark">#</span>                        </div>                        <div class="flex-grow-1 overflow-hidden">                            <p class="text-truncate mb-0">' + e.username + "</p>                        </div>                        <div>" + a + "</div>                        </div>                </a>            </li>"
            ...
            l.addEventListener("click", function(e) {
                ...
                // console.log(uid.querySelector(".chat-user-list"))

                // user_id = uid.getAttribute("id");

                // user_id = user_id.split('contact-id-');
    ...
    }), e("callList", function(e, t) {
console.log(t)
        null !== e ? console.log("Something went wrong: " + e) : ( t.callList.forEach(function(e, t) {
            ...
            document.getElementById("callList").innerHTML += '<li id="calls-id-' + e._id + '" >        <div class="d-flex align-items-center">        <div class="chat-user-img flex-shrink-0 me-2">            ' + s + '        </div>            <div class="flex-grow-1 overflow-hidden">                <p class="text-truncate mb-0">' + e.username + '</p>                <div class="text-muted font-size-12 text-truncate"><i class="' + e.callArrowType + '"></i> ' + e.dateTime + '</div>            </div>            <div class="flex-shrink-0 ms-3">                <div class="d-flex align-items-center gap-3">                    <div>                        <h5 class="mb-0 font-size-12 text-muted">' + e.callTime + "</h5>                    </div>                    <div>                       " + a + "                    </div>                </div>            </div>        </div>      </li>"
    ...
    }), e("contacts", function(e, t) {
console.log(t)
        var i, l;
        null !== e ? console.log("Something went wrong: " + e) : ((f=t).contacts.sort(function(e, t) {
            return e.username.localeCompare(t.name)
        }), l = i = "", f.contacts.forEach(function(e, t) {
            ...
            i = '<li>              <div class="d-flex align-items-center">                  <div class="flex-shrink-0 me-2">                      <div class="avatar-xs">                          ' + a + '                      </div>                  </div>                  <div class="flex-grow-1">                      <h5 class="font-size-14 m-0" >' + e.username + '</h5>                  </div>                  <div class="flex-shrink-0">                      <div class="dropdown">                          <a href="#" class="text-muted dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">                              <i class="bx bx-dots-vertical-rounded align-middle"></i>                          </a>                          <div class="dropdown-menu dropdown-menu-end">                              <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Edit <i class="bx bx-pencil ms-2 text-muted"></i></a>                              <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Block <i class="bx bx-block ms-2 text-muted"></i></a>                              <a class="dropdown-item d-flex align-items-center justify-content-between" href="#">Remove <i class="bx bx-trash ms-2 text-muted"></i></a>                          </div>                      </div>                  </div>              </div>          </li>';
            var s = '<div class="mt-3" >              <div class="contact-list-title">' + e.username.charAt(0).toUpperCase() + '                </div>          <ul id="contact-sort-' + e.username.charAt(0) + '" class="list-unstyled contact-list" >';
            l != e.username.charAt(0) && (document.getElementsByClassName("sort-contact")[0].innerHTML += s), document.getElementById("contact-sort-" + e.username.charAt(0)).innerHTML = document.getElementById("contact-sort-" + e.username.charAt(0)).innerHTML + i, l = e.username.charAt(0)
    ...
    document.querySelector("#galleryfile-input").addEventListener("change", function() {
        ...
        this.files && [].forEach.call(this.files, function(e) {
            if (!/\.(jpe?g|png|gif)$/i.test(e.username)) return alert(e.username + " is not an image");
            var t = new FileReader,
                a = "";
            t.addEventListener("load", function() {
                removeimg++, s && s.classList.add("show"), C.push(t.result), a += '<div class="media-img-list" id="remove-image-' + removeimg + '">          <a href="#">              <img src="' + this.result + '" alt="' + e.username + '" class="img-fluid">          </a>            <i class="ri-close-line image-remove" onclick="removeImage(`remove-image-' + removeimg + '`)"></i>          </div>', i.insertAdjacentHTML("afterbegin", a), 0
            }), t.readAsDataURL(e)
        })
    });
    ...
    function _(e) {
        ...
        console.log("print e ", uid, e)
        t = e, a = function(e, t) {

            if(uid){
                v = uid

            console.log(v, "logged in user 2")
            var l, n, a, i, o, s, r, c;
            null !== e ? console.log("Something went wrong: " + e) : (l = "users" == m ? t.chats : t.channel_chat, document.getElementById(m + "-conversation").innerHTML = "", n = 0, l.forEach(function(t, e) {
                var a, s, i;

                // console.log(t.from_id, v)
                0 < n ? --n : (a = t.from_id == v ? " right" : " left", (s = f).contacts.find(function(e) {
                    return e._id == t.from_id
